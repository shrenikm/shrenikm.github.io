...
There are more recent methods that solves this problem using a closed form solution [[1]](#ref1). To comply with our initial objective and constraints, I used one of the earliest methods developed for solving this problem: COM generation using preview control. For details, see [[2]](#ref2) and [[3]](#ref3).
